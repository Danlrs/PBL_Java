//package Testes.unitary.CardTest;
//
...
//
//        UUID id = cardFacade.create(email, cardNumber, expiryDate, cvv, "Card 1");
...
//        UUID id1 = cardFacade.create(email, cardNumber, expiryDate, cvv, "Card 1");
//        assertNotNull(cardFacade.getById(id1));
//
//        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
//            cardFacade.create(email, cardNumber, expiryDate, cvv, "Card 2");
//        });
//
//        assertEquals("Cartão com esse número já cadastrado!", exception.getMessage());
//    }
//}
