//package Testes.unitary.PurchaseTest;
//
...
//import aplication.facade.PurchaseTestFacade.PurchaseTestFacade;
//import aplication.facade.CardTestFacade.CardTestFacade;
...
//
//    @Test
//    public void createReceiptPurchaseTest() throws Exception {
...
//
//        UUID purchaseId = purchaseFacade.create(email1, eventId, "A1", 100.0, boleto);
//
...
//
//    @Test
//    public void createCardPurchaseTest() throws Exception {
//        Calendar calendar = Calendar.getInstance();
//        calendar.set(2025, Calendar.SEPTEMBER, 10);
//        String name = "Show de Rock";
//        String description = "Banda XYZ";
...
//        userFacade.create(login1, password1, nameUser1, cpf1, email1, isAdmin1);
//
//        UUID cardId = cardFacade.create(email1, cardNumber, expiryDate, cvv, "Card 1");
...
//        eventFacade.addSeatByEventId("A1", eventId);
//
//        UUID purchaseId = purchaseFacade.create(email1, eventId, cardId, "A1", 100.0);
//
//        assertNotNull(purchaseFacade.getById(purchaseId));
//        assertEquals(eventId, purchaseFacade.getEventByPurchaseId(purchaseId));
//        assertEquals(login1, purchaseFacade.getUserLoginByPurchaseId(purchaseId));
...
//
//    @Test
//    public void ConfirmReceiptPurchaseFromEmailTest() throws Exception {
//        Calendar calendar = Calendar.getInstance();
//        calendar.set(2025, Calendar.SEPTEMBER, 10);
//        String name = "Show de Rock";
//        String description = "Banda XYZ";
...
//
//    @Test
//    public void ConfirmCardPurchaseFromEmailTest() throws Exception {
//        Calendar calendar = Calendar.getInstance();
//        calendar.set(2025, Calendar.SEPTEMBER, 10);
//        String name = "Show de Rock";
//        String description = "Banda XYZ";
